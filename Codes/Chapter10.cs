...
namespace WindowsFormsApplication1
{
    public partial class Chapter10 : Form
    {
        ...
        string name;
        int count;
        public Chapter10(string user)
        {
            InitializeComponent();
            //timer
            this.C10timer.Tick += new System.EventHandler(this.C10timer_Tick);
            C10timer.Start();
        ...
        public Chapter10(string[] giveback, string t, string user, int check)
        {
            InitializeComponent();
            count = check;
            name = user;
        ...
        private void btnFinish_Click(object sender, EventArgs e)
        {
            ...
            //Question 3
            if (rdbFalse3.Checked)
            {
                correction += 1;
                arrayC[3] = "Correct";
                returnf[3] = "false";
            }
            else if (rdbTrue3.Checked)
            {
                arrayC[3] = "Incorrect";
                returnf[3] = "true";
            }
            ...
            if (trimtext == "extensibility mechanism")
            {
                correction += 1;
                arrayC[6] = "Correct";
            ...
            //Let Result.cs know this is chapter 10
            chp = 10;
            //Stop the timer
            C10timer.Stop();
            time = lbltimer.Text;
        ...
        private void Chapter10_Load(object sender, EventArgs e)
        {
            lblQ1.Focus();
        }
        ...
        public void showAns()
        {
            ...
            lblA3.Text = "Answer: False";
            lblA4.Text = "Answer: Class";
            lblA5.Text = "Answer: Behavior";
            lblA6.Text = "Answer: Extensibility Mechanism";
            lblA7.Text = "Answer: Common features";
            lblA8.Text = "Answer: All of the above";
            lblA9.Text = "Answer: Categorization";
            lblA10.Text = "Answer: B";
            lblA11.Text = "Answer: A";
            lblA12.Text = "Answer: C";             
        }
        //This function would show all the correct answer
        ...
        private void C10timer_Tick(object sender, EventArgs e)
        {
