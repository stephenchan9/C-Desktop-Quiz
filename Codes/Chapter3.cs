...
namespace WindowsFormsApplication1
{
    public partial class Chapter3 : Form
    {
        ...
        public Chapter3(string[] giveback, string t, string user, int check)
        {
            InitializeComponent();
            count = check;
            name = user;
        ...
        private void btnFinish_Click(object sender, EventArgs e)
        {
            ...
            if (trimtext == "forces" || trimtext == "force")
            {
                correction += 1;
                arrayC[5] = "Correct";
            ...
            //Let Result.cs know this is chapter 3
            chp = 3;
            //Stop the timer
            C3timer.Stop();
            time = lbltimer.Text;
        ...
        public void showAns()
        {
            ...
            lblA4.Text = "Answer: Process flow";
            lblA5.Text = "Answer: Forces";
            lblA6.Text = "Answer: Generic";
            lblA7.Text = "Answer: Blocked Pattern";
            lblA8.Text = "Answer: Circular";
            lblA9.Text = "Answer: ISO 1120:0002";
            lblA10.Text = "Answer: A";
