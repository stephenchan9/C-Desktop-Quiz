...
namespace WindowsFormsApplication1
{
    public partial class Chapter4 : Form
    {
        ...
        public Chapter4(string[] giveback, string t, string user, int check)
        {
            InitializeComponent();
            count = check;
            name = user;
        ...
        private void btnFinish_Click(object sender, EventArgs e)
        {
            ...
            if (trimtext == "iterations" || trimtext == "iteration")
            {
                correction += 1;
                arrayC[4] = "Correct";
            ...
            if (trimtext == "order" || trimtext == "orders")
            {
                correction += 1;
                arrayC[5] = "Correct";
            ...
            if (trimtext == "concurrent development")
            {
                correction += 1;
                arrayC[6] = "Correct";
            ...
            //Let Result.cs know this is chapter 4
            chp = 4;
            ...
            //,which chapter the questions are from and the answers user inputted 
            this.Hide();
        ...
        public void showAns()
        {
            ...
            if (txtTBA1.Text == "iterations" || txtTBA1.Text == "iteration")
                lblA4.ForeColor = System.Drawing.Color.Green;

            if (txtTBA2.Text == "order" || txtTBA2.Text == "orders")
                lblA5.ForeColor = System.Drawing.Color.Green;

            if (txtTBA3.Text == "concurrent development")
            ...
            lblA4.Text = "Answer: Iterations";
            lblA5.Text = "Answer: Order";
            lblA6.Text = "Answer: Concurrent Development";
            lblA7.Text = "Answer: Unreasonable implementation in order to get a working product";
            lblA8.Text = "Answer: Inception";
            lblA9.Text = "Answer: Personal Software Process Model";
            lblA10.Text = "Answer: B";
            lblA11.Text = "Answer: C";
