...
{    
    public partial class Chapter5 : Form
    {
        ...
        public Chapter5(string user)
        {
            InitializeComponent();
            // timer
            this.C5timer.Tick += new System.EventHandler(this.C5timer_Tick);
            C5timer.Start();
        ...
        public Chapter5(string[] giveback, string t, string user, int check)
        {
            InitializeComponent();
            count = check;
            name = user;
        ...
        {            
            ...
            if (trimtext == "user stories" || trimtext == "user story")
            {
                correction += 1;
                arrayC[4] = "Correct";
            ...
            //Let the Result.cs know this is chapter 5
            chp = 5;
            //Stop the timer
            C5timer.Stop();
        ...
        private void Chapter5_Load(object sender, EventArgs e)
        {
            lblQ1.Focus();
        }
        ...
        public void showAns()
        {
            ...
            if (txtTBA1.Text == "user story" || txtTBA1.Text == "user stories")
                lblA4.ForeColor = System.Drawing.Color.Green;

            if (txtTBA2.Text == "adaptable")
                lblA5.ForeColor = System.Drawing.Color.Green;

            if (txtTBA3.Text == "refactoring")
            ...
            lblA4.Text = "Answer: User Stories";
            lblA5.Text = "Answer: Adaptable";
            lblA6.Text = "Answer: Refactoring";
            lblA7.Text = "Answer: Frame Working";
            lblA8.Text = "Answer: Use to accomadate rapid changes the customers implement";
            lblA9.Text = "Answer: Customer Feedback";
        ...
        private void C5timer_Tick(object sender, EventArgs e)
        {
